      ...
      <Container id="register" className="my-5 register-body">
        <Row>
          <Col xs={12} md={7} className="mt-5">
            ...
            <p>
              Create an account today. Simply fill in the form below and start
              donating
            </p>
          ...
          <Form.Control type="password" placeholder="Confirm your password" />
            ...
            <div className="tml-links mb-5">
              <Link
                className="text-decoration-none register-link d-block mb-2"
                to="/login"
              >
                Log in
              </Link>
              ...
              <Link className="text-decoration-none register-link" to="/login">
                Lost your password?
              </Link>
            </div>
          </Col>
          ...
          <Col xs={12} md={4} className="mt-5">
            ...
            <h6 className="institution-registration-text mt-4">
              If you would like to register an Institution and be part of Ummati
              to help needy people directly click{" "}
              <button
                onClick={registerInstitutionHandler}
                className="button-as-anchorTag"
              >
                here
              </button>{" "}
              and start helping others today!
            </h6>
            <button
              className="btn btn-primary btn-block btn-xl register-button mt-4"
              onClick={registerInstitutionHandler}
            >
              Join us today
            </button>
